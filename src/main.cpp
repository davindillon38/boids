...
#include <vector>
#include <memory>
#include "GLViewBoidSwarm.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewBoidSwarm > glView( Aftr::GLViewBoidSwarm::New( args ) );
